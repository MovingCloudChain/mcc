...
function createStorage(content, secret) {
  return node.mcc.storage.createStorage(content, secret)
}
...
describe('Test storage', () => {
  ...
  it('Normal storage test', async function () {
    ...
    var res = await node.submitTransactionAsync(node.mcc.storage.createStorage('1234abcd', account1.password))
