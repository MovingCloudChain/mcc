...
var normalizer = 100000000; // Use this to convert MCC amount to normal value
...
function genNormalAccount() {
  ...
  var keys = mcc.crypto.getKeys(password)
  return {
